...
def root(request: Request, error: Optional[str] = None):
    ...
    if error == "ssl":
        alert = """<div class="alert alert-danger" role="alert"><span><strong>Error </strong>- The link you&#39;re trying to shorten doesn&#39;t support SSL. curtlink.xyz can only shorten links with valid SSL certificates.</span></div>"""
    elif error == "blocked":
        alert = """<div class="alert alert-danger" role="alert"><span><strong>Error </strong>- The domain of the link you&#39;re trying to shorten was blocked by curtlink.xyz. You cannot create shortened links for it.</span></div>"""
    else:
        alert = """"""
